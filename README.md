...
The lifecycle is REGISTERED, REVIEWED, ACKNOWLEDGED. Normalized IDs, distinct HTTPS hosts, replay rejection and forged attribution are tested. Run `python -m pytest -q` and `genvm-lint contract/schema_sentry.py`.
